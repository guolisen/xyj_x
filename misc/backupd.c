  ...
  switch (new_state)  
      { 
       ...
       if (lt[LT_HOUR] * 100 + lt[LT_MIN] != tlist[BACKUPING])
        ...
        HIC"┋西游快讯┋现在是 "+lt[LT_HOUR]+" 点 "+lt[LT_MIN]+" 分,系统将在 "+(tlist[BACKUPING] / 100) % 100+
        " 点 "+tlist[BACKUPING] % 100+" 分自动备份所有玩家的数据，期间游戏会有停滞……\n"NOR,users());
       ...
       case BACKUPING:
        ...
        message("channel:rumor",
        HIR"┋西游快讯┋现在是 "+lt[LT_HOUR]+" 点 "+lt[LT_MIN]+" 分,系统开始自动备份所有玩家数据，请稍候......\n"NOR,users());
