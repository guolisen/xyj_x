...
string *list=({"yg-moon","yg-hyd","yg-xueshan","yg-dragon","yg-fangcun",
                "yg-putuo","yg-wdd","yg-wzg","yg-hell",
});
/*string *list=({"yg-dragon","yg-fangcun","yg-hell","yg-hyd","yg-jjf","yg-moon",
                "yg-pansi","yg-putuo","yg-wdd","yg-wzg","yg-xueshan",
        });
*/
...
int recover_death()
{
    ...
    if (who->query("obstacle/rebirth") < 0)
    {
        message_vision ("$N对$n摇了摇头：救命毫毛不黳也。\n",me,who);
        return 1;
    }
...
int accept_object(object me, object obj)
{
    ...
    if ((me->query("rulaitask/kind") != "擒") || ( obj != me->query("rulaitask/guai") ))
    {
    ...
    {
        tell_room(environment(),"几个金刚把"+obj->name()+"押了下去。\n\n");
        //destruct (obj);
