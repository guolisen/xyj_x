...
mapping data()
{
	return ([
       ...
       5 : ({ "give", "女孩",         "girl",        "银子(silver)",                     "1" }),
      10 : ({ "give", "男孩",         "boy",         "银子(silver)",                     "1" }),
      15 : ({ "give", "小女孩",       "kid",         "银子(silver)",                     "1" }),
      20 : ({ "give", "小男孩",       "kid",         "银子(silver)",                     "1" }),
      25 : ({ "give", "苦力",         "kuli",        "银子(silver)",                     "1" }),
      30 : ({ "give", "酸秀才",       "suan xiucai", "银子(silver)",                     "1" }),
      40 : ({ "give", "游客",         "youke",       "银子(silver)",                     "1" }),
      45 : ({ "give", "路人",         "lu ren",      "银子(silver)",                     "1" }),
      50 : ({ "give", "江湖艺人",     "yi ren",      "银子(silver)",						"1" }),
      55 : ({ "give", "浣衣女",       "girl",        "银子(silver)",						"1" }),
      60 : ({ "give", "阿七婆",       "aqi po",      "银子(silver)",                     "1" }),
      65 : ({ "give", "农夫",         "farmer",      "银子(silver)",                     "1" }),
      70 : ({ "give", "樵夫",         "qiao fu",     "银子(silver)",                     "1" }),
