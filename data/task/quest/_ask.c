...
mapping data()
{
 ...
 //只是把西天的后移了，其他没改
 5080600 : ({ "ask", "比丘僧",       "biqiu seng",         "取经",               "1" }),
 5080700 : ({ "ask", "比丘尼",       "biqiu ni",           "取经",               "1" }),
 5080800 : ({ "ask", "金刚",         "jin gang",           "取经",               "1" }),
 5080900 : ({ "ask", "菩萨",         "pu sa",              "取经",               "1" }),

 5810000 : ({ "ask", "仙童",         "xian tong",          "佛学",               "1" }),
 5820000 : ({ "ask", "阿罗",         "a luo",              "佛学",               "1" }),
 5830000 : ({ "ask", "揭谛",         "jie di",             "佛学",               "1" }),
 5840000 : ({ "ask", "白雄尊者",     "baixiong zunzhe",    "取经",               "1" }),
 5850000 : ({ "ask", "燃灯古佛",     "randeng gufo",       "取经",               "1" }),
 5860000 : ({ "ask", "如来佛",       "rulai fo",           "取经",               "1" }),
