...
int main(object me, string arg)
{
	...
	notify_fail("你试着练习" + skill_name + "，但是并没有任何进步。\n");

	if(skill_basic <= skill && !random(100))
		write("你的" + skill_name + "很难提高了，还是向你师父请教请教吧！\n");

	message_vision("$N按着所学练习练" + skill_name + "。\n", me);
