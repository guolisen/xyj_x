...
int query_cor()
{
	...
	return min2(final, 40);
}

int query_int()
{
	int final = (int)query("int") +query_temp("apply/intelligence")
...
int query_spi()
{
	int final = (int)query("spi") +query_temp("apply/spirituality")
...
int query_con()
{
	int final = (int)query("con") +query_temp("apply/constitution")
...
int query_kar()
{
	int final = (int)query("kar") + query_temp("apply/karma") 
